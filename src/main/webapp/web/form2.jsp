...
<div style="background-image:url('pic9.jpg')">
    ...
    <div class="head"> <center><h2><font color="black" size="60px">Faculty Registration Form</font></h2></center> </div>
...
<div class="container">
  <form  action="insert1.jsp"  method="get"> 
    ...
    <div class="row">
      <div class="col-25">
          <label for="contact"><font color="black">Contact No</font></label>
      </div>
      <div class="col-75">
        <input type="text" id="contact" name="contac" placeholder="Your Contact Number">
      </div>
    </div>
    <br><br>
