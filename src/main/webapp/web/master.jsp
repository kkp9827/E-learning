...
<div class="w3-container w3-center w3-light-grey" style="padding:128px 16px" id="pricing">
  <h1><b>Courses Which are Available Here</b></h1>
...
<!-- Contact Section -->
<div class="w3-container w3-light-grey" style="padding:2px 16px" id="contact">
  <h3 class="w3-center"><b>CONTACT DETAILS</b></h3>
