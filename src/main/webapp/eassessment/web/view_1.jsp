...
<html>
  ...
  String sql="Select * from faculity where fid='"+request.getParameter("name") +"'";
  ...
  <tr><td>Fid</td><td><%=rs.getString("fid") %></td></tr>
  <tr><th>FName</th><td><%=rs.getString("fname") %></td></tr>
  <tr><th>Courseid</th><td><%=rs.getString("courseid") %></td></tr>
