...
<div class="w3-top">
  <div class="w3-bar w3-white w3-animate-opacity" id="myNavbar">
    <a href="masterpage.jsp?page=1" class="w3-bar-item w3-button w3-wide">Home</a>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="#registration" onclick="w3_close()" class="w3-bar-item w3-button">REGISTRATION</a>
